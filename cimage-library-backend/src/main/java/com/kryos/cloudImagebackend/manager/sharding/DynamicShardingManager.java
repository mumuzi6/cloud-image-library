package com.kryos.cloudImagebackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // cloud_image_library_112321321,cloud_image_library_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "cloud_image_library." + tableName) // 确保前缀合法
